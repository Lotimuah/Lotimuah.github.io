...
$$
\begin{aligned}
Q^*(s, a) = \mathbb{E}_{s' \sim \epsilon} \big[ r + \gamma max_{a'} Q^*(s', a') \mid s, \; a \big]\\
\end{aligned}
$$
...
$$
\begin{aligned}
L_{i}(\theta_{i}) = \mathbb{E}_{s, a \sim \rho(\cdot)} [ (y_i - Q(s, a; \theta_{i}))^2 ] \qquad where, y_i = \mathbb{E}_{s' \sim \epsilon} [ r + \gamma \max_{a'} Q(s', a'; \theta_{i-1}) \mid s, \; a]
\end{aligned}
$$
